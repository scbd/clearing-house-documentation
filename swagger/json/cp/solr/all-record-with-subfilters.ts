        ...
        parameters: [
          {
            ...
            schema: {
              type: 'string',
              example: 'schema_s:absCheckpoint AND government_s:cy AND usages_ss:60EA2F49\\-A9DD\\-406F\\-921A\\-8A1C9AA8DFDD AND keywords_ss:357DBB22\\-6A6C\\-4C49-BA1F\\-037320B09247'
            },
              ...
              'application/json': {
                example: {
                  response: {
                    ...
                    docs: [
                      {
                        uniqueIdentifier_s: `${domain}-cp-ad-257216-2`,
                        schema_s: `${name.value}Checkpoint`,
                        ...
                        government_s: 'ht',
                        url_ss: [
                          `${baseUrl}/database/record?documentID=257216`
                        ]
                      }
                    ]
                  },
