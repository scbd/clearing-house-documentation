...
export default (url: string): OpenAPI3 => ({
  ...
  info: {
    title: 'IRCC API',
    description: 'API for creating and managing IRCC records, including workflows and draft publishing.',
    version: '1.0.0'
  },
  servers: [
    {
  ...
  paths: {
    '/documents/schemas/{schema}': {
      post: {
        summary: 'Create a new IRCC record',
        description: 'Creates a new IRCC record schema and initiates the workflow process.',
