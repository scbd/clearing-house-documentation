...
Searches public Capacity Development Initiative records of the Clearing-House Mechanism through the Apache Solr index. The playground below shows the common query patterns: all records of the type, filtered by country, by free text, by region, and with combined sub-filters.
