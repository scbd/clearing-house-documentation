...
Deletes a Contact record from the Clearing-House Mechanism by its unique identifier (`uid`). Use this to remove records that are outdated or no longer relevant.
