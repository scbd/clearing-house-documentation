...
const lmo: SchemaDescriptor = {
  ...
  "commonUses": { title: "Common use(s) of the LMO", titleLink: '/thesaurus/organism-common-uses', type: 'term[]', example: [{"identifier":"F816F788-BBC3-4ADB-9979-AE07CDED094E"}] },
  "techniqueUsed": { title: "Techniques used for the modification", titleLink: '/thesaurus/technique-used', type: 'term[]', mandatory: true, example: [{"identifier":"0368E952-6D50-43D3-B23A-EFA438B410A9"}] },
