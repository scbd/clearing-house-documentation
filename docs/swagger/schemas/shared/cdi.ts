...
export const cdiFields: Record<string, Field> = {
  ...
  "status": { title: "Status", titleLink: '/thesaurus/cbi-status', type: 'term', mandatory: true, example: {"identifier":"73E2AC27-D964-487C-A4E6-0997BB27AF01"} },
  ...
  "activityScope": { title: "Type of capacity development initiative", titleLink: '/thesaurus/cbi-cpb-types', type: 'term', example: {"identifier":"2DFCDD0B-5D62-4016-829F-8E70E767875A"} },
  ...
  "Category(ies) of capacity development activities": { title: "categories", titleLink: '/thesaurus/cbi-cats', type: 'term[]', example: [{"identifier":"FE6EC4EA-55E7-4E90-80AD-FE4B54707B73"},{"identifier":"5B6177DD-5E5E-434E-8CB7-D63D67D5EBED","customValue":{"en":"Test Info"}}] },
  "Main target group(s)/beneficiary(ies)": { title: "targetGroups", titleLink: '/thesaurus/cbi-audience', type: 'term[]', example: [{"identifier":"D8862526-B776-4FD2-8C62-6DF9D5E92166"},{"identifier":"5B6177DD-5E5E-434E-8CB7-D63D67D5EBED","customValue":{"en":"Test Info"}}] },
  "Related CBD subject areas": { title: "cbdSubjects", titleLink: '/thesaurus/cbd-subjects', type: 'term[]', example: [{"identifier":"CBD-SUBJECT-FOR"}] },
  "Key areas and strategic measures for capacity-building and development": { title: "absKeyAreas", titleLink: '/thesaurus/key-areas', type: 'term[]', example: [{"identifier":"9096451F-09FF-4E70-8345-3C7D84DEF545"}] },
  ...
  "Type(s) of funding source(s)": { title: "fundingSourceTypes", titleLink: '/thesaurus/cbi-funding-src', type: 'term[]', example: [{"identifier":"74EBA28E-1F0C-4157-BD47-C8492487AD70"}] },
