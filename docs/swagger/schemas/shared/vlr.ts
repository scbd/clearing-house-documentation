...
export const vlrFields: Record<string, Field> = {
  ...
  "resourceTypes": { title: "Type of resource", titleLink: '/thesaurus/resource-type-vlr', type: 'term[]', mandatory: true, example: [{"identifier":"7BBF86FE-68E5-4ED8-8174-7DD8D302C583"},{"identifier":"AA04CE23-471C-40E4-A0CC-53C9F49DABD4"}] },
  ...
  "countryRegions": { title: "Geographical or political/economic group(s)", titleLink: '/thesaurus/countries', type: 'term[]', example: [{"identifier":"ao"},{"identifier":"A23DD6C0-44C5-418D-83B5-461D79D2721A"}] },
  "gbfTargets": { title: "Kunming-Montreal Global Biodiversity Framework Target(s)", titleLink: '/thesaurus/gbf-targets', type: 'term[]', example: [{"identifier":"GBF-TARGET-01"},{"identifier":"GBF-TARGET-17"}] },
  "aichiTargets": { title: "Aichi Targets", type: 'term[]' },
  "cbdSubjects": { title: "CBD Subject Areas", titleLink: '/thesaurus/cbd-subjects', type: 'term[]', mandatory: true, example: [{"identifier":"CBD-SUBJECT-AGR"},{"identifier":"CBD-SUBJECT-CPB-HTPI"}] },
  ...
  "nagoya.keyAreas": { title: "Key areas and strategic measures for capacity-building and development addressed by the resource", titleLink: '/thesaurus/key-areas', type: 'term[]', example: [{"identifier":"14E5882E-B433-4877-AA6B-B47F602C4BA6"}] },
