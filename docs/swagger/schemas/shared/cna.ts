...
export const cnaFields: Record<string, Field> = {
  ...
  "absJurisdiction": { title: "Area of jurisdiction for granting access to genetic resources", titleLink: '/thesaurus/abs-jurisdictions', type: 'term[]', mandatory: true, example: [{"identifier":"7437F880-7B12-4F26-AA91-CED37250DD0A"}] },
  "absJurisdictionName": { title: "Name of the jurisdiction(s)", type: 'lstring' },
  "absGeneticResourceTypes": { title: "Keywords to describe scope of CNA responsibilities", titleLink: '/thesaurus/abs-genetic-resource-types', type: 'term[]', example: [{"identifier":"357DBB22-6A6C-4C49-BA1F-037320B09247"}] },
