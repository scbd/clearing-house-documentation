...
const ircc: SchemaDescriptor = {
  ...
  "keywords": { title: "Keywords to describe the subject-matter or genetic resource(s) covered by the permit or its equivalent", titleLink: '/thesaurus/permit-keywords', type: 'term[]', example: [{"identifier":"357DBB22-6A6C-4C49-BA1F-037320B09247"}] },
  ...
  "usages": { title: "1. Indicate if the permit or its equivalent covers commercial and/or non-commercial use", titleLink: '/thesaurus/permit-usage', type: 'term[]', mandatory: true, example: [{"identifier":"5E833A3F-87D1-4ADD-8701-9F1B76383017"}] },
