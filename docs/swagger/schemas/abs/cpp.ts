...
const cpp: SchemaDescriptor = {
  ...
  "resourceTypes": { title: "Type of resource", type: 'term[]', mandatory: true, example: [{"identifier":"2F193E6A-FE21-447F-8270-BAED8AD0DD5A"},{"identifier":"5DDFFC34-4278-42B3-83D6-449862EC1C16"}] },
  ...
  "countryRegions": { title: "Geographical or political/economic group(s)", type: 'term[]', example: [{"identifier":"af"},{"identifier":"A23DD6C0-44C5-418D-83B5-461D79D2721A"}] },
  "gbfTargets": { title: "", type: 'term[]', example: [{"identifier":"GBF-TARGET-01"}] },
  "aichiTargets": { title: "Aichi Targets", type: 'term[]' },
  "cbdSubjects": { title: "CBD Subject Areas", type: 'term[]', example: [{"identifier":"CBD-SUBJECT-DSHL"},{"identifier":"CBD-SUBJECT-CC"}] },
  "nagoya": { title: "", type: 'object' },
  "nagoya.subjects": { title: "ABS Thematic Areas", type: 'term[]', mandatory: true },
  "nagoya.keyAreas": { title: "Key areas and strategic measures for capacity-building and development addressed by the resource", type: 'term[]', example: [{"identifier":"0DCF8438-9479-4F6B-B356-FDFCB0C4D564"}] },
