...
const nmcc: SchemaDescriptor = {
  ...
  "keywords": { title: "Please select the relevant keywords", type: 'term[]', mandatory: true, example: [{"identifier":"7F45AB1F-9925-482E-B0CD-CD842960825F"}] },
  "thematicAreas": { title: "Thematic area(s)", type: 'term[]', example: [{"identifier":"1D2710D3-75C8-475D-8634-F912F06DAF25"},{"identifier":"822EC80937524039A912E87DC0041A89"}] },
