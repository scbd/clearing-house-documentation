...
const nationalReport: SchemaDescriptor = {
  ...
  fields: {
  "government": { title: "Welcome to your country's ({government}) 7th National Report overview. Please select an option to proceed.", titleLink: '/thesaurus/countries', type: 'term', mandatory: true, example: {"identifier":"af"} },
  ...
  "levelOfProgress": { title: "Please indicate the current level of progress towards this national target", titleLink: '/thesaurus/countries', type: 'term', example: [{"identifier":"ao"},{"identifier":"A23DD6C0-44C5-418D-83B5-461D79D2721A"}] },
  ...
  "gbfGoal": { title: "", titleLink: '/thesaurus/countries', type: 'term', example: [{"identifier":"ao"},{"identifier":"A23DD6C0-44C5-418D-83B5-461D79D2721A"}] },
