...
const nationalTarget: SchemaDescriptor = {
  ...
  "globalGoalAlignment": { title: "Contribution to global Goals", type: 'term[]', example: [{"identifier":"GBF-GOAL-A"}] },
  "globalTargetAlignment": { title: "Alignment with global targets", type: 'term[]', mandatory: true, example: [{"identifier":"GBF-TARGET-01","degreeOfAlignment":{"identifier":"AABF237C-F906-40D2-9595-5226C8B18A58"}}] },
  ...
  "implementingConsiderations": { title: "Which of the considerations for implementation in Section C of the GBF have been taken into account in developing this national target, and the actions to implement it", type: 'term[]', example: [{"identifier":"76553677-A17D-4DE3-8CDD-6010CDCF8A90"}] },
  ...
  "headlineIndicators": { title: "Headline indicators", type: 'term[]', example: [{"identifier":"GBF-INDICATOR-1.1"},{"identifier":"GBF-INDICATOR-A.1"},{"identifier":"GBF-INDICATOR-A.2"},{"identifier":"GBF-INDICATOR-A.3"},{"identifier":"GBF-INDICATOR-A.4"}] },
  "binaryIndicators": { title: "Binary indicators", type: 'term[]', example: [{"identifier":"KMGBF-INDICATOR-BIN-1"}] },
  "componentIndicators": { title: "Component indicators", type: 'term[]', example: [{"identifier":"GBF-INDICATOR-114"}] },
  "complementaryIndicators": { title: "Complementary indicators", type: 'term[]', example: [{"identifier":"GBF-INDICATOR-114"}] },
