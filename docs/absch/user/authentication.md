...
Authenticates a CBD account and returns the authorization token used by the protected endpoints of the ABS Clearing-House API. CBD accounts are shared across the clearing houses, so this call takes no realm.
