...
Deletes a Contact record from the Biosafety Clearing-House by its unique identifier (`uid`). Use this to remove records that are outdated or no longer relevant.
