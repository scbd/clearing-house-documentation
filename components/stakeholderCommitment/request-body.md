...
<schema-table schema="stakeholderCommitment">
  ...
  <schema-row title="Type of Organization" title-link="thesaurus/stakeholderCommitment/organization-types.html" field="organizationType" mandatory type="ETerm"/>

  <schema-row title="Jurisdiction" title-link="thesaurus/stakeholderCommitment/jurisdiction.html" field="jurisdiction" mandatory type="ETerm" />
  <schema-row title="Countries"  title-link="thesaurus/general/countries.html" field="jurisdictionCountries" mandatory type="ETerm[]" example='{ "identifier": "af" }'/>
  <schema-row title="Regions" title-link="thesaurus/general/regions.html" field="jurisdictionRegions" mandatory type="ETerm[]" />
  ...
  <schema-row title="Primary National Target" title-link="thesaurus/stakeholderCommitment/gbf-targets.html" field="primaryGlobalAlignment" mandatory type="ETerm" />
  <schema-row title="Primary global target" field="primaryNationalTarget" mandatory type="EReference" />
  <schema-row title="Other Global Alignment(s)" title-link="thesaurus/stakeholderCommitment/gbf-targets.html" field="otherGlobalAlignments" type="ETerm[]" />
  ...
  <schema-row title="Indicators" field="indicators" title-link="thesaurus/stakeholderCommitment/gbf-headline-indicators.html" type="ETerm[]" />
  <schema-row title="Elements of the Framework" title-link="thesaurus/stakeholderCommitment/gbf-target-considerations.html" field="implementingConsiderations" type="ETerm[]" />
  <schema-row title="Coverage Countries" title-link="thesaurus/general/countries.html" field="coverageCountries" type="ETerm[]" example='{ "identifier": "af" }' />
  <schema-row title="Coverage Regions" title-link="thesaurus/general/regions.html" field="coverageRegions" type="ETerm[]" />
  ...
  <schema-row title="Linked To NBSAP Countries" title-link="thesaurus/general/countries.html" field="linkedToNbsapCountries" type="ETerm[]" example='{ "identifier": "af" }' />
