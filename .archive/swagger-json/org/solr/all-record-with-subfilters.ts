  ...
  paths: {
    '/index': {
      get: {
        ...
        tags: [
          'Get All results with sub-filters'
        ],
        parameters: [
          {
            name: 'q',
            ...
            schema: {
              type: 'string',
              example: 'schema_s:organization AND government_s:cy AND usages_ss:60EA2F49\\-A9DD\\-406F\\-921A\\-8A1C9AA8DFDD AND keywords_ss:357DBB22\\-6A6C\\-4C49-BA1F\\-037320B09247'
            },
              ...
              'application/json': {
                example: {
                  response: {
                    ...
                    docs: [
                      {
                        uniqueIdentifier_s: `${domain}-org-scbd-255937-1`,
                        schema_s: 'organization',
                        title_s: 'P&G',
                        title_AR_s: 'P&G',
                        title_EN_s: 'P&G',
                        title_ES_s: 'P&G',
                        ...
                        government_s: 'ht',
                        url_ss: [
                          `${baseUrl}/database/record?documentID=255937`
                        ]
                      }
                    ]
                  },
