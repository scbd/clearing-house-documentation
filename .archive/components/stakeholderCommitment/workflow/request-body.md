...
| --------------- | ------------- | ------------- | -------- |
| `document`      | Object        | The schema object that represents the body of the record type. For example, the [stakeholderCommitment schema](/ort/stakeholderCommitment/schema). | Yes      |
